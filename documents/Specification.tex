...
\end{figure}
 ...
 \item Only one global clock is allowed which should be appropriate as only few circuits need more than one clock and even complex circuits (say a microprocessor) can be implemented with only one clock.
 \begin{figure}[h]
\centering
\includegraphics{inverter_ring2.pdf}
\caption{Inverter ring.}\label{fig:invert}
\end{figure}
...
\caption{GUI UML diagram}\label{fig:erptsqfit}
\end{figure}
...
\section{Lorem Ipsum}
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tempor magna nec mi. Donec commodo purus. Maecenas nulla leo, sollicitudin eget, tempor at, dignissim id, tortor. Sed sed velit. Nullam eu pede. Vestibulum turpis. In nisi leo, interdum sed, sodales quis, volutpat ut, tortor. Suspendisse velit. Integer nisi. Nunc fermentum euismod est. Sed at lacus non turpis gravida varius. Donec aliquet est non elit. Sed ac ipsum a turpis mollis egestas. Aenean pharetra. Fusce feugiat, pede sed viverra hendrerit, velit felis mollis nunc, ac consectetur mi sapien id sem.

Sed pulvinar nibh vitae felis. Nullam viverra. Quisque molestie faucibus nibh. Etiam tincidunt pellentesque augue. Sed vitae ante non tortor consequat condimentum. Nulla ultrices augue at sem. Morbi varius. In luctus ornare est. Donec cursus consequat magna. Nullam placerat orci eu orci. Nullam venenatis quam vitae turpis. Nulla facilisi. Curabitur rhoncus. Vivamus bibendum mauris ut lorem. Donec condimentum turpis ut pede. Donec molestie ultrices risus. Quisque at est et velit volutpat dapibus. Vestibulum aliquam commodo ligula. Proin libero lectus, egestas ac, dictum in, iaculis eu, magna. Aliquam hendrerit.

Nulla facilisi. Pellentesque tempus tortor nec magna. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Sed dignissim est in metus. Vestibulum ac pede quis neque ullamcorper interdum. Nulla vestibulum lectus a sem. Morbi id justo. Donec suscipit, tellus non porttitor scelerisque, nisl neque porta odio, sit amet dapibus mi turpis quis justo. Nam aliquet, sem a malesuada volutpat, massa felis vulputate arcu, non fermentum dolor erat vitae libero. In justo mi, varius congue, sagittis eget, auctor quis, dolor. Quisque tincidunt tortor ac diam. Mauris eget mi. Praesent scelerisque. Fusce convallis cursus dolor. Nam imperdiet mi ultricies mi.

Nam mollis erat tincidunt sem. Nam bibendum eleifend mi. Mauris ante erat, ornare eu, cursus et, tincidunt a, sem. Aliquam est tortor, ultricies id, vulputate in, consectetur sit amet, lorem. Curabitur faucibus, sapien consequat vehicula tincidunt, dui dui commodo neque, in lobortis augue nibh nec justo. Praesent malesuada tellus sollicitudin odio. Phasellus ut leo. Suspendisse potenti. Maecenas nec nisi eget sapien eleifend lobortis. Curabitur dapibus pulvinar massa.

Nunc nec arcu et tellus dictum rhoncus. Duis odio. Mauris nec ante consequat justo mollis rhoncus. Mauris mollis metus nec est. Nullam in mauris et mauris sollicitudin cursus. Phasellus volutpat adipiscing quam. Nulla facilisi. Morbi adipiscing pede vitae quam. Praesent purus metus, fringilla a, tincidunt vel, ultrices a, nibh. Quisque vulputate auctor lectus. Nunc risus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed vel tortor. Nullam lectus. Nam eleifend, mauris at laoreet rutrum, urna nunc fermentum neque, vel dictum enim libero non dui.
