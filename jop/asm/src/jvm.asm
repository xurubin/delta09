...
//
			...
			ldi	io_led			// write byte to LED/HEX
			stmwa
			ldi 1
			stmwd
			wait
...
///////////////Ignore first byte due to some strange behaviour of the USB_JTAG
ignore_1:
...
//			ldi	io_uart			// acknowledge of packet received
//			stmwa
//			ldi 49	
//			stmwd		
//			wait
//			wait
			...
			ldi	io_led			// write file index to LED/HEX
			stmwa
			ldm heap
			stmwd
			wait
...
//
			...
			ldi	io_hex			// write file length to LED/HEX
			stmwa
			ldi 127
			stmwd
			wait
