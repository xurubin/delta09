...
\begin{figure}[!h]
\centering
\includegraphics[width=12cm]{Delta_Logic.eps}
...
David Weston & GUI --  Circuit representation.\\
Christopher Wilson & GUI -- Graphical.\\
