...
import org.delta.logic.Xor;

/**
 * Class to represent the "model" of a XorGate in the circuit diagram.
 * @author Group Delta 2009
 */
public class XorGate extends DeltaComponent {
	/** Needed for correct serialization. */
	private static final long serialVersionUID = 1L;

	/**
	 * Creates a new XorGate at a default position.
	 */
	public XorGate() {
	...
	/**
	 * Creates a new XorGate at the given position on the screen.
	...
	protected void replaceUserObject() {
	    Gate gate = GateFactory.createGate(Xor.class, 2);
